...
FOLD_PATH="/home/kyuminkim/datasets/table/pieta/inference_results/llama3_full_wikisql_kernel4_coord_in_context_step3.json"

HYDRA_FULL_ERROR=1 python src/test/inference/main_llama3.py evaluation_module=divide_conquer_vllm_llama3_incontext_wikisql_coord_2shot_tensor_parallel evaluation_module.LLM_module.model_path="$MODEL_PATH" evaluation_module.LLM_module.tensor_parallel_size=8 evaluation_module.save_dir="$FOLD_PATH" evaluation_module.batch_size=null evaluation_module.dataset.json_path="/home/kyuminkim/datasets/table/wikisql/wikisql_kernel4_coord_incontext_step2.json" evaluation_module.dataset.kernel_size=4 evaluation_module.dataset.csv_dir="/home/kyuminkim/datasets/table/pieta/subtable/wikisql_kernel4_coord_incontext_step2" evaluation_module.dataset.moving_size=1 \
